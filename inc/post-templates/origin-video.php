...
<?php if( !is_single() ): ?>
    ...
    <div class="post-content" >
        ...
        <?php $video_embed = get_post_meta( $post->ID, '_webuza_video_embed', true ); ?>

        <?php if( !empty( $video_embed ) ): ?>
            <div class="video-wrap"><?php echo stripslashes( htmlspecialchars_decode( $video_embed ) ); ?></div>
        <?php else:?>
            <?php webuza_video( $post->ID ); ?>
        <?php endif;?>
