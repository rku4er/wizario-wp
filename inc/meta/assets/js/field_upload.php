...
class Redux_Options_upload {
    ...
    */
    function render() {
        ...
        echo ' <a data-update="Select File" data-choose="Choose a File" href="javascript:void(0);"class="redux-opts-upload button-secondary"' . $upload . ' rel-id="' . $this->field['id'] . '">' . __('Upload', WEBUZA_THEME_NAME ) . '</a>';
        echo ' <a href="javascript:void(0);" class="redux-opts-upload-remove"' . $remove . ' rel-id="' . $this->field['id'] . '">' . __('Remove Upload', WEBUZA_THEME_NAME ) . '</a>';
    ...
    function enqueue() {
        ...
        if ( $wp_version < "3.5" ) {
            wp_enqueue_script(
                ...
                get_template_directory_uri() . '/inc/meta/assets/js/field_upload_3_4.js',
