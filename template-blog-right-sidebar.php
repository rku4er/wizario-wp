...
/*-----------------------------------------------------------------*
* Template Name: Page - Blog Right Layout
*-----------------------------------------------------------------*/
...
<div class="container main-content ">
    ...
    <div class="row">
        ...
        <div id="post-area" class="col_main col_main col_8">

            <article id="post-24" class="post-24 post type-post status-publish format-standard hentry category-news category-stories tag-full-width tag-slideshow tag-webuza">
                ...
                <div class="post-header single-post">
                    ...
                    <h1>Post with custom sidebar, right layout</h1>
                ...
                <a class="post-featured-img" href="http://webuza.com/demo/wp/wizario/demo/htdocs/?p=24">
                    <img class="attachment-full wp-post-image" width="1400" height="672" title="" alt="!!!!webuza_dummy1" src="http://webuza.com/demo/wp/wizario/wp-content/uploads/2013/10/webuza_dummy1.jpg">
                </a>
        ...
        <div id="sidebar" class="col_main col_4 align-main-right">
