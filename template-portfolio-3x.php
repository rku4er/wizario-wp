...
<?php endif; ?>
    ...
    <div class="container main-content port-content3">
        <div class="separator-class-x3">&nbsp;</div>
        <div class="row-portfolio row-x3">
            ...
            <div id="portfolio" class="portfolio-items" data-fade="1">
                ...
                if( have_posts() ) : while( have_posts() ) : the_post();
                    ...
                    <div class="col span_3 element <?php echo $project_cats; ?>" data-project-cat="<?php echo $project_cats; ?>" style="opacity: 0;">
                        <div class="work-item">

                            <div class="portfolio-image-x3">
                                <?php if( !empty( $custom_thumbnail) ){
                                    echo '<img class="custom-thumbnail" src="' .$custom_thumbnail. '" alt="' .get_the_title(). '" />';
                                } else {
                                    if ( has_post_thumbnail() ) {
                                        echo get_the_post_thumbnail($post->ID, 'portfolio-3x', array('title' => ''));
                                    } else {
                                        echo '<img src="'.get_template_directory_uri().'/images/no-portfolio-item-3.jpg" alt="no image added yet." />';
                                    }
                                } ?>
        ...
        <div class="clear"></div>
        <div class="separator-class3">&nbsp;</div>
