...
?>
    ...
    <script>
        jQuery(document).ready(function($){
            ...
            $('#portfolio-filters > a').click(function(){ return false; });
            ...
            if( $('#page-header-bg').length > 0 ) { $('#page-header-bg').css('margin-bottom','3.3em'); }
...
<?php endif; ?>
    ...
    <div class="container main-content port-content4">
        <div class="separator-class-x4">&nbsp;</div>
        <div class="row-portfolio row-x4">
            ...
            <div id="portfolio" class="portfolio-items" data-fade="1">
                ...
                if( have_posts() ) : while( have_posts() ) : the_post();
                    ...
                    <div class="col span_4 element <?php echo $project_cats; ?>" data-project-cat="<?php echo $project_cats; ?>" style="opacity: 0;">
                        <div class="work-item">

                            <div class="portfolio-image-x4">
                                <?php if( !empty( $custom_thumbnail) ){
                                    echo '<img class="custom-thumbnail" src="' .$custom_thumbnail. '" alt="' .get_the_title(). '" />';
                                } else {
                                    if ( has_post_thumbnail() ) {
                                        echo get_the_post_thumbnail($post->ID, 'portfolio-4x', array('title' => ''));
                                    } else {
                                        echo '<img src="'.get_template_directory_uri().'/images/no-portfolio-item-4.jpg" alt="no image added yet." />';
                                    }
                                } ?>
        ...
        <div class="clear"></div>
        <div class="separator-class4">&nbsp;</div>
